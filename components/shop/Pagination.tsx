...
/**
 * Pagination — Composant client de navigation entre pages du catalogue.
 * Preserve tous les query params existants (category, sort, search, etc.)
 * lors de la navigation entre les pages.
 * Style : pills arrondies, primary-500 pour la page active.
 */
export default function Pagination({
  ...
  return (
    <nav
      aria-label="Navigation des pages produits"
